...
#   filename:  dc.json
#   timestamp: 2024-02-20T16:12:10+00:00
...
class ResourceType(BaseModel):
    ...
    resourceTypeGeneral: ResourceTypeGeneral = Field(
...
class GeoLocationPoint(BaseModel):
    ...
    pointLongitude: float = Field(..., description='Longitudinal dimension of point.')
    pointLatitude: float = Field(..., description='Latitudinal dimension of point.')
...
class GeoLocationPolygon(BaseModel):
    ...
    polygonPoints: List[PolygonPoint] = Field(
        ..., description='A point location in a polygon.', min_items=3
    )


class GeoLocation(BaseModel):
    geoLocationPoint: Optional[GeoLocationPoint] = Field(
        None, description='A point location in space.'
    )
    geoLocationBox: Optional[GeoLocationBox] = Field(
        None, description='The spatial limits of a box.'
    )
    ...
    geoLocationPolygon: Optional[GeoLocationPolygon] = Field(
        None,
...
class Doi(BaseModel):
    __root__: constr(regex=r'10\..+/.+') = Field(
...
class Uri(BaseModel):
    __root__: str = Field(..., description='For adding future URI validation.')
...
class Dc1(BaseModel):
    ...
    language: Optional[Language] = Field(
        None, description='Primary language of the resource.'
    )
    ...
    sizes: Optional[List[str]] = Field(
        None, description='Unstructures size information about the resource.'
    )
