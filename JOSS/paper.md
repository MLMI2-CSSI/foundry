...
Foundry-ML is built upon a solid base. We have developed Foundry-ML using Materials Data Facility [@mdf-2019; @mdf-2016] services, Foundry-ML users can upload large datasets (MDF supports multi-TB datases, with potentially millions of files), making them easy to share, use, and discover by the rest of the scientific community. Building on the Materials Data Facility [@mdf-2019; @mdf-2016] and Globus, Foundry-ML users can publish large datasets (e.g., MDF supports multi-TB datasets, with potentially millions of files), making them easy to share, use, and discover by the rest of the scientific community. All datasets are made available through the Fondry-ML software, the Foundry-ML webapp and also via Globus endpoints that support both Globus and HTTPS access.
...
# Documentation
Detailed Foundry-ML documentation is available via GitBook at the following location [GitBook documentation](https://ai-materials-and-chemistry.gitbook.io/foundry/v/docs/). However, it may be easier to We also have made available a number of [example notebooks](https://github.com/MLMI2-CSSI/foundry/tree/main/examples) that show how to publish and retrieve Foundry-ML datasets. 
